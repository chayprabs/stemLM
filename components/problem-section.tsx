...
export function ProblemSection() {
  return (
    <section className="bg-[#F8F9FC] px-5 py-16 md:px-12 md:py-24">
      <div className="mx-auto max-w-[1100px]">
        ...
        <p className="mb-12 max-w-[520px] text-[15px] leading-[1.7] text-[#64748B]">
          Engineering and STEM students already use AI every day, but the
          experience is broken. These tools are built for general questions —
          not for the visual, structured reasoning that physics, circuits,
          and mathematics require.
        </p>
